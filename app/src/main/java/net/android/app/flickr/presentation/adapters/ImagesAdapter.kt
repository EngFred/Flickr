...
class ImagesAdapter : PagingDataAdapter<FlickrImage, ImagesAdapter.ImageViewHolder>(diffCallback = differCallback) {
    ...
    inner class ImageViewHolder( private val binding: FlickrImageItemBinding ) : ViewHolder( binding.root ) {
        fun bind( image: FlickrImage ) {
            ...
            binding.root.setOnClickListener {
                ...
                Log.d("CLICK", "Small sized image url: ${image.smallSizeImageUrl}\nMedium sized image url: ${image.mediumSizeImageUrl}\nLarge sized image url: ${image.largerSizeImageUrl}")
            }
        }
    }
